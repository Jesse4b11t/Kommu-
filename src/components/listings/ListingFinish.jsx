...
import listingFinish from '../../schema/listings/listingFinish';

const ListingFinish = (props) => {
...
ListingFinish.propTypes = wizardPropTypes.listingPropTypes;

export default withFormik({
    validationSchema: listingFinish,
