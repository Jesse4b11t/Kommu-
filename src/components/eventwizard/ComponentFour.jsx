            ...
            <Form onSubmit={handleSubmit}>
                <div className="row">
                    <div className="form-group col-md-6">
                        ...
                        <ErrorMessage name="dateStart" component="div" className="has-error" />{' '}
                    </div>
                    <div className="form-group col-md-6">
                        <label htmlFor="dateEnd">Event End Date</label>
                        <Field type="date" name="dateEnd" className="form-control" />
                        <ErrorMessage name="dateEnd" component="div" className="has-error" />
                    </div>
                    <div className="button-group pt-3 row">
                        ...
                        <div className="col-sm-1">
                            <button type="button" className="btn btn-primary" onClick={onNextClicked}>
                                {nextLabel}
                            </button>
                        </div>
                    </div>
